...
if($id == ""){
	$query = $pdo->prepare("INSERT INTO $pagina set nome = :campo1, descricao = :campo2");
}else{
	$query = $pdo->prepare("UPDATE $pagina set nome = :campo1, descricao = :campo2 WHERE id_categoria = '$id'");
}
